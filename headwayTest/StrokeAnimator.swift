...
func performStrokeAnimation(text: String, font: CTFont, inView view: UIView) {
    performStrokeAnimation(text: text, font: font, characterSpacing: 10.0, wordSpacing: 20.0, duration: 2.0, borderWidth: 1.0, borderColor: UIColor.white.cgColor, inView: view)
